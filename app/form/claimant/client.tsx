  ...
  if (endorserLink) {
    return (
      <div style={{ padding: '40px', maxWidth: '800px', margin: '0 auto' }}>
        <h1 style={{ color: '#0B5FFF', marginBottom: '20px' }}>Endorser Link Generated</h1>
    ...
    <div style={{ padding: '40px', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <form onSubmit={handleSubmit}>
        <div style={{ marginBottom: '20px' }}>
          <label htmlFor="narrative" style={{ display: 'block', marginBottom: '8px', fontWeight: 'bold' }}>
        ...
        <div style={{ marginBottom: '20px' }}>
          <label htmlFor="endorserName" style={{ display: 'block', marginBottom: '8px', fontWeight: 'bold' }}>
            Endorser Name *
          </label>
          <input
            type="text"
        ...
        <div style={{ marginBottom: '20px' }}>
          <label htmlFor="endorserEmail" style={{ display: 'block', marginBottom: '8px', fontWeight: 'bold' }}>
            Endorser Email *
          </label>
          <input
            type="email"
