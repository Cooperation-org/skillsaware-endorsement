export default function Home() {
  return (
    <div style={{ padding: '40px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <section style={{ marginBottom: '40px', backgroundColor: '#e8f5e9', padding: '30px', borderRadius: '8px', border: '2px solid #4caf50' }}>
        <h2 style={{ color: '#2e7d32', fontSize: '24px', marginBottom: '20px' }}>🔐 PDF Certificate Verification</h2>

        <p style={{ fontSize: '16px', lineHeight: '1.8', color: '#555', marginBottom: '20px' }}>
          Every SkillsAware certificate includes <strong>multi-layer cryptographic protection</strong> that ensures
          authenticity and detects any tampering. Our verification system checks multiple aspects of the certificate:
        </p>

        <div style={{ backgroundColor: '#fff', padding: '20px', borderRadius: '6px', marginBottom: '20px' }}>
          <h3 style={{ color: '#2e7d32', fontSize: '18px', marginBottom: '15px' }}>How Verification Works</h3>
          <ul style={{ fontSize: '15px', lineHeight: '1.8', color: '#555', paddingLeft: '20px', marginBottom: '0' }}>
            <li>
              <strong>Metadata Integrity:</strong> Verifies HMAC-SHA256 signature and content hash stored in PDF metadata
            </li>
            <li>
              <strong>Creator Validation:</strong> Ensures the PDF was created by SkillsAware and not modified with external editors
            </li>
            <li>
              <strong>Content Verification:</strong> Extracts and validates actual PDF text against stored credential data
            </li>
            <li>
              <strong>Context-Aware Matching:</strong> Checks that names, signatures, and skill codes appear in their expected locations
            </li>
          </ul>
        </div>

        <div style={{ backgroundColor: '#fff3cd', padding: '15px', borderRadius: '6px', marginBottom: '20px', border: '1px solid #ffc107' }}>
          ...
          <p style={{ fontSize: '14px', color: '#856404', marginTop: '8px', marginBottom: '0' }}>
            Checking metadata alone isn&apos;t enough - someone could edit the PDF text while keeping metadata intact.
            Checking content alone isn&apos;t secure - someone could forge a PDF with fake text.
            Our system verifies <strong>both layers</strong> and ensures they match, providing complete tamper detection.
          </p>
        </div>
      ...
      <section id="verification-api" style={{ marginBottom: '40px' }}>
        ...
        <div style={{ backgroundColor: '#f5f5f5', padding: '20px', borderRadius: '5px' }}>
          ...
          <div style={{ marginBottom: '15px', backgroundColor: '#e8f5e9', padding: '12px', borderRadius: '5px', border: '2px solid #4caf50' }}>
            <code style={{ fontSize: '14px', color: '#2e7d32', backgroundColor: '#fff', padding: '4px 8px', borderRadius: '3px', fontWeight: 'bold' }}>
            ...
            <details style={{ fontSize: '13px', color: '#555', marginTop: '8px' }}>
              ...
              <pre style={{ backgroundColor: '#f9f9f9', padding: '10px', borderRadius: '4px', marginTop: '8px', overflow: 'auto' }}>
