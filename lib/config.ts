...
const TENANT_CONFIGS: Record<string, TenantConfig> = {
  skillsaware: {
    ...
    webhook_url: process.env.SKILLSAWARE_WEBHOOK_URL || 'http://localhost:3001/api/webhook',
    webhook_secret: process.env.SKILLSAWARE_WEBHOOK_SECRET || 'dev-webhook-secret',
    s3_bucket: process.env.S3_BUCKET || 'skillsaware-artifacts',
    s3_prefix: process.env.S3_PREFIX || 'endorsements',
